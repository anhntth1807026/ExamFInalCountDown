...
namespace ExamFinalCountDown.Controllers
{
    public class ExamSubjectsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ExamSubjectId,ExamSubjectName")] ExamSubject examSubject)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ExamSubjectId,ExamSubjectName")] ExamSubject examSubject)
        {
            if (ModelState.IsValid)
            {
